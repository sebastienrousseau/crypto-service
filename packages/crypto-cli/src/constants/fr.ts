...
export const translations = {
    ...
    CLI_DESCRIPTION : 'Crypto CLI est une interface de ligne de commande simple mais puissante qui peut être utilisée pour effectuer des opérations cryptographiques courantes à partir de l\'invite de commande ou du terminal.',
    CLI_FN_1_TTL    : 'Generate',
    CLI_FN_1_DES    : 'Génère une nouvelle paire de clés OpenPGP. Prend en charge les clés RSA et ECC.',
    ...
    CLI_HDL_1_DES   : 'Nous avons besoin que vous nous fournissiez les informations suivantes :',
