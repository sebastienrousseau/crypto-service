import decrypt from '../../src/commands/decrypt.command';
...
const data = {
  ...
  encryptedMessage: 'Hello Crypto Service APIs!',
...
// # sourceMappingURL=decrypt.command.test.js.map
// Language: typescript
