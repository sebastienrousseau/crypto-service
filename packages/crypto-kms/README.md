...
<p align="center">
  <img src="https://raw.githubusercontent.com/sebastienrousseau/crypto-service/main/assets/crypto-kms-logo.svg" alt="crypto-kms logo" width="128" />
</p>

<h1 align="center">crypto-kms</h1>

<p align="center">
  Enterprise key management adapters for AWS KMS, Google Cloud KMS,
  Azure Key Vault, and HashiCorp Vault -- unified under a single
...
- [Overview](#overview) -- what crypto-kms does and why
...
Node >= 22. The local provider has zero additional dependencies.
...
**No native dependencies.** The local provider uses the audited
`@noble/*` family via crypto-lib -- pure TypeScript, no C bindings.

**Timing-safe comparisons.** Signature verification and MAC
...
```bash
pnpm --filter @sebastienrousseau/crypto-kms docs
```
