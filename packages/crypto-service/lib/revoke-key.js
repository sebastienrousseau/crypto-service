...
let publicKey = await readFile("./src/key/rsa_public.key", function(e) { if (e) {throw e;} });
let privateKey = await readFile("./src/key/rsa_private.key", function(e) { if (e) {throw e;} });
